			...
			<div class="row isotope-grid">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                            <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto,idproducto FROM producto WHERE  idproducto=1;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
							<a class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04" href="carrito.php?id=<?php echo $resultado["idproducto"];?>">
								Add to Cart
							</a>
						</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=2;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
							<a class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04" href="carrito.php?id=<?php echo $resultado["idproducto"];?>">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=3;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=4;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=5;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
						<img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=6;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
						<img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=7;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=8;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
						<img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=9;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=10;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=11;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
						<img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=12;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=13;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
						<img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=14;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=15;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=16;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=17;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
						<img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=18;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=19;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=20;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=21;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=22;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
						<img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=23;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=24;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=25;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=26;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=27;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=28;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=29;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
                        <img src="img/<?PHP
                             $query1=mysqli_query($con,"SELECT foto, idproducto FROM producto WHERE idproducto=30;");
                             $resultado=mysqli_fetch_array($query1);
                             echo $resultado['foto'];
                            ?>" alt="IMG-PRODUCT">
