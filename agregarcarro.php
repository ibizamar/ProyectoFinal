...
$qry=mysqli_query("SELECT * FROM producto WHERE id='".$idproducto."'");
...
//herramienta array.
$carro[$id]=array('idproducto'=>$id,'cantidad'=>$cantidad,
'imagen'=>$row['foto'],'pnombre'=>$row['pnombre'],'precio'=>$row['precio'],
...
//header("Location:vercarrito.php?".SID."&id=".$id."&precio=".$cantidad);
